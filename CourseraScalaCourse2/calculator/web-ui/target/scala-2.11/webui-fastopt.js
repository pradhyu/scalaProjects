...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var returnExp = $as_sci_Map($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(namedExpressions, f, bf));
  return returnExp
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var deltaSqrt = $uD($g["Math"]["sqrt"](x));
  var firstSoln = (((-$uD(b.apply__O())) + deltaSqrt) / (2 * $uD(a.apply__O())));
  var secondSoln = (((-$uD(b.apply__O())) - deltaSqrt) / (2 * $uD(a.apply__O())));
  var array = [firstSoln];
  ...
  var solns = $as_sci_Set($as_sc_SetLike(jsx$1).$$plus__O__sc_Set(secondSoln));
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(solns$1) {
    return (function() {
      return solns$1
    })
  })(solns));
...
/** @constructor */
var $c_Lcalculator_Calculator$$anonfun$1 = (function() {
  $c_sr_AbstractFunction1.call(this);
...
/** @constructor */
var $h_Lcalculator_Calculator$$anonfun$1 = (function() {
  /*<skip>*/
});
...
$c_Lcalculator_Calculator$$anonfun$1.prototype.apply__T2__T2 = (function(item) {
  var name = $as_T(item.$$und1$f);
  var exp = $as_Lcalculator_Signal(item.$$und2$f);
  $m_Lcalculator_Signal$();
...
var $d_Lcalculator_Calculator$$anonfun$1 = new $ClassTypeData({
